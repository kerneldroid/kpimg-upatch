...
extern "C" JNIEXPORT jboolean JNICALL Java_me_bmax_upatch_Natives_nativeReady(JNIEnv *env, jclass clz, jstring superKey)
{
...
extern "C" JNIEXPORT jint JNICALL Java_me_bmax_upatch_Natives_nativeKernelPatchVersion(JNIEnv *env, jclass clz,
                                                                                       jstring superKey)
{
    if (!superKey) return -EINVAL;
    const char *skey = env->GetStringUTFChars(superKey, NULL);
...
extern "C" JNIEXPORT jlong JNICALL Java_me_bmax_upatch_Natives_nativeSu(JNIEnv *env, jclass clz, jstring superKey,
...
extern "C" JNIEXPORT jlong JNICALL Java_me_bmax_upatch_Natives_nativeThreadSu(JNIEnv *env, jclass clz, jstring superKey,
...
extern "C" JNIEXPORT jint JNICALL Java_me_bmax_upatch_Natives_nativeSuNums(JNIEnv *env, jclass clz, jstring superKey)
{
    const char *skey = env->GetStringUTFChars(superKey, NULL);
...
extern "C" JNIEXPORT jintArray JNICALL Java_me_bmax_upatch_Natives_nativeSuUids(JNIEnv *env, jclass clz,
                                                                                jstring superKey)
{
    const char *skey = env->GetStringUTFChars(superKey, NULL);
...
extern "C" JNIEXPORT jobject JNICALL Java_me_bmax_upatch_Natives_nativeSuProfile(JNIEnv *env, jclass clz,
                                                                                 jstring superKey, jint uid)
{
    ...
    jclass cls = env->FindClass("me/bmax/upatch/Natives$Profile");
...
extern "C" JNIEXPORT jlong JNICALL Java_me_bmax_upatch_Natives_nativeLoadKernelPatchModule(JNIEnv *env, jclass clz,
                                                                                           jstring superKey,
                                                                                           jstring modulePath,
                                                                                           jstring jargs)
{
...
extern "C" JNIEXPORT jobject JNICALL Java_me_bmax_upatch_Natives_nativeControlKernelPatchModule(JNIEnv *env, jclass clz,
                                                                                                jstring superKey,
                                                                                                jstring modName,
                                                                                                jstring jctlargs)
{
    ...
    jclass cls = env->FindClass("me/bmax/upatch/Natives$KPMCtlRes");
    jmethodID constructor = env->GetMethodID(cls, "<init>", "()V");
...
extern "C" JNIEXPORT jlong JNICALL Java_me_bmax_upatch_Natives_nativeUnloadKernelPatchModule(JNIEnv *env, jclass clz,
                                                                                             jstring superKey,
                                                                                             jstring modName)
{
    const char *skey = env->GetStringUTFChars(superKey, NULL);
...
extern "C" JNIEXPORT jlong JNICALL Java_me_bmax_upatch_Natives_nativeKernelPatchModuleNum(JNIEnv *env, jclass clz,
                                                                                          jstring superKey)
{
    const char *skey = env->GetStringUTFChars(superKey, NULL);
...
extern "C" JNIEXPORT jstring JNICALL Java_me_bmax_upatch_Natives_nativeKernelPatchModuleList(JNIEnv *env, jclass clz,
                                                                                             jstring superKey)
{
    const char *skey = env->GetStringUTFChars(superKey, NULL);
    long rc = sc_kpm_nums(skey);
...
extern "C" JNIEXPORT jstring JNICALL Java_me_bmax_upatch_Natives_nativeKernelPatchModuleInfo(JNIEnv *env, jclass clz,
                                                                                             jstring superKey,
                                                                                             jstring modName)
{
    const char *skey = env->GetStringUTFChars(superKey, NULL);
...
extern "C" JNIEXPORT jlong JNICALL Java_me_bmax_upatch_Natives_nativeGrantSu(JNIEnv *env, jclass clz, jstring superKey,
...
extern "C" JNIEXPORT jlong JNICALL Java_me_bmax_upatch_Natives_nativeRevokeSu(JNIEnv *env, jclass clz, jstring superKey,
                                                                              jint uid)
{
    const char *skey = env->GetStringUTFChars(superKey, NULL);
...
extern "C" JNIEXPORT jstring JNICALL Java_me_bmax_upatch_Natives_nativeSuPath(JNIEnv *env, jclass clz, jstring superKey)
{
    const char *skey = env->GetStringUTFChars(superKey, NULL);
...
extern "C" JNIEXPORT jboolean JNICALL Java_me_bmax_upatch_Natives_nativeResetSuPath(JNIEnv *env, jclass clz,
