...
#define MAGISK_POLICY_PATH "/data/adb/up/bin/magiskpolicy"
#define AP_PACKAGE_CONFIG_PATH "/data/adb/up/package_config"
...
// Load UPatch package_config configuration file
