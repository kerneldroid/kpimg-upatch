# Rebranded KernelPatch for UPatch

Credits to the original [KernelPatch](https://github.com/bmax121/KernelPatch) by bmax121.
...
If you are using Android, [UPatch](https://github.com/kerneldroid/UPatch) would be a better choice.
